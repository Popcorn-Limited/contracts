...
contract MainOracle is Owned, IPriceOracle {
    /// @inheritdoc IPriceOracle
    string public constant name = "MainOracle";
    ...
    constructor(address _governor) Owned(_governor) {}
        ...
        )
    {
        ...
        if (oracle == address(0)) revert PriceOracle_NotSupported(base, quote);
