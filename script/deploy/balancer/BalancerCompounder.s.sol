...
contract Deploy is Script {
    ...
    function run() public returns (BalancerCompounder strategy) {
        string memory json =
            vm.readFile(string.concat(vm.projectRoot(), "/script/deploy/balancer/BalancerCompounderDeployConfig.json"));
        ...
        strategy.initialize(
            ...
            abi.encode(json.readAddress(".strategyInit.minter"), json.readAddress(".strategyInit.gauge"))
        );
