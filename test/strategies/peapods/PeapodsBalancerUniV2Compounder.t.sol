...
contract PeapodsBalancerUniV2CompounderTest is BaseStrategyTest {
    ...
    function setUp() public {
        _setUpBaseTest(0, "./test/strategies/peapods/PeapodsBalancerUniV2CompounderTestConfig.json");
    }
    ...
    function test__initialization() public override {
        string memory json = vm.readFile("./test/strategies/peapods/PeapodsBalancerUniV2CompounderTestConfig.json");
