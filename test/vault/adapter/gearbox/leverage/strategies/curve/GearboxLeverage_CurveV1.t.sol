...
import {
    GearboxLeverage_CurveV1
} from "../../../../../../../src/vault/adapter/gearbox/leverage/strategies/curve/GearboxLeverage_CurveV1.sol";

interface ILeverageAdapter is IAdapter {
    function adjustLeverage(uint256 amount, bytes memory data) external;
}

contract GearboxLeverage_CurveV1_Test is AbstractAdapterTest {
