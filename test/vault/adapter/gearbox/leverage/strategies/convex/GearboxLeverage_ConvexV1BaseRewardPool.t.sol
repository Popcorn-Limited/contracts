...
import {
    GearboxLeverage_ConvexV1BaseRewardPool
} from "../../../../../../../src/vault/adapter/gearbox/leverage/strategies/convex/GearboxLeverage_ConvexV1BaseRewardPool.sol";

interface ILeverageAdapter is IAdapter {
    function adjustLeverage(uint256 amount, bytes memory data) external;
}

contract GearboxLeverage_ConvexV1BaseRewardPool_Test is AbstractAdapterTest {
    ...
    function _setUpTest(bytes memory testConfig) internal {
        ...
        setUpBaseTest(
            IERC20(DAI),
            address(new GearboxLeverage_ConvexV1BaseRewardPool()),
            addressProvider,
            10,
            "Gearbox Leverage ",
            false
