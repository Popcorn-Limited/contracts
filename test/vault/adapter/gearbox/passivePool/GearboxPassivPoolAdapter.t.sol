...
contract GearboxPassivePoolAdapterTest is AbstractAdapterTest {
    IAddressProvider addressProvider =
        IAddressProvider(0xcF64698AFF7E5f27A11dff868AF228653ba53be0);
    ...
    function setUp() public {
        ...
        testConfigStorage = ITestConfigStorage(
            address(new GearboxPassivePoolTestConfigStorage())
        );
    ...
    function _setUpTest(bytes memory testConfig) internal {
        ...
        poolService = IPoolService(
            IContractRegistry(addressProvider.getContractsRegister()).pools(
                _pid
            )
        );
    ...
    function increasePricePerShare(uint256) public override {
        ...
        IBurnable(address(dieselToken)).burn(
